...
![Executor框架结构图](http://wx4.sinaimg.cn/mw1024/78d85414ly1fsbu5l3d9zj20mj0l9myt.jpg "图1 Executor框架结构图")
...
* 无界的任务队列：通过LinkedBlockingQueue实现。由于是无界的任务队列，当系统的线程数小于corePoolSize数时，线程池会生成新的线程执行任务，反之，则任务直接加入队列进行等待，一但任务处理速度跟不上线程的创建速度，无界队列会无限增长，直到耗尽系统内存。
